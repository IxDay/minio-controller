...
var (
	...
	projectImage = "platipy.io/minio-controller:v0.0.1"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting minio-controller integration test suite\n")
...
var _ = BeforeSuite(func() {
	...
	cmd := exec.Command("mise", "build:image", projectImage)
	_, err := utils.Run(cmd)
